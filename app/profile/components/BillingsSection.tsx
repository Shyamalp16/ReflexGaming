  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        whileHover="hover"
        className="bg-gradient-to-br from-orange-500/5 via-purple-500/5 to-pink-500/5 
        dark:from-orange-500/10 dark:via-purple-500/10 dark:to-pink-500/10 
        rounded-xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-sm border border-white/10
        hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)] transition-all duration-300"
      >
        <div className="flex items-start justify-between flex-wrap gap-6">
          <div className="w-full md:w-auto">
            <div className="flex items-center gap-4 mb-6">
              <span className="bg-gradient-to-br from-orange-500 to-pink-500 p-3 rounded-xl">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="md:pl-8 border-l border-gray-200/10">
          <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-4">Plan Features</h4>
        ...
        <div className="space-y-4">
          <div className="bg-white/5 dark:bg-gray-800/50 rounded-lg p-4 border border-gray-200/10 dark:border-gray-700/10">
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center gap-12 text-sm">
                ...
                <span className="text-white font-medium">${subscriptionData.price}</span>
              </div>
              <div className="flex justify-between items-center gap-12 text-sm">
          ...
          <motion.div whileHover={{ scale: 1.02 }}>
            <Button 
              className="w-full bg-gradient-to-r from-orange-500 to-pink-500 text-white hover:from-orange-600 hover:to-pink-600 transition-all duration-300"
            >
              Change Plan
            </Button>
          </motion.div>
          ...
          <div className="space-y-2">
            <motion.div whileHover={{ scale: 1.02 }}>
              <Button 
                className="w-full border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
              >
          ...
          <div className="bg-orange-500/5 dark:bg-orange-500/10 rounded-lg p-4 border border-orange-200/10 dark:border-orange-700/10">
            <div className="flex items-start gap-3">
              <div className="p-2 bg-orange-500/10 rounded-lg">
                <Sparkles size={16} className="text-orange-500" />
              </div>
              <div>
                <h4 className="text-sm font-medium text-gray-900 dark:text-white">Pro Benefits</h4>
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                  You're saving $5.99/month with annual billing. <button className="text-orange-500 hover:text-orange-600 font-medium">Learn more</button>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-xs text-center text-gray-500 dark:text-gray-400">
            Need help? <button className="text-orange-500 hover:text-orange-600">Contact support</button>
          </div>
        </div>
      </div>
